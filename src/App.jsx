...
function App() {
    ...
    const handleSearch = (event) => {
        ...
        let returnedPhotos = photo_data.filter((photo) => {
            return photo.author.toLowerCase().includes(searchTerm);
        })
    ...
    const [photos, setPhotos] = useState(photo_data);

    return (
        <>
            <Search callback={handleSearch}/>
            <Gallery photo_list={photos}/>
        </>
    )
}
